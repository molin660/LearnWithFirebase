...
/////////-----------------------------------------------------
        ...
        //db is database from NoSQL, back tick below ` `, also needs $ to inject variable into string
        ...
        //collection is specific to user so only the authenticated account can access it. 
        const data = {
            userId: userId,
            email: userEmail,
            itemText: itemText,
        ...
        //lefside is field name: right side is object
        ...
        await setDoc(doc(userTodoListCollection, docUniqueId), data); //obtain collection and document then puts data into documents
    } catch (error) {
